...
$message = $sms->message('Inscriction au  reussie! Vous pouvez vous connecter pour ajouter des produits dès maintenant et ajouter des produits.
http://jagokela.fasocivic.org/connect.php')
    ->from(22676600797)
    ->as('Jagokela')
    ->to($telephone)
    ->send();
    ...
    <div class="container">
	    ...
	    <div class="col-lg-4 col-sm-5 portfolio-item" >
                ...
                <div class="card h-80">
                 ...
                 <div class="card-block"style="color:white!important; background:#f3bc08;">
                        <p class="card-text">   <b>D&#596;&#596;nni-D&#596;&#596;nin - </b>03 mois à 3000F<b><h7 class="card-title"></h7></b></div>
						 ...
						 <p class="card-text"><b>* Gestion du stock</font></b>
						  <p class="card-text" style="color:white">* Accès au requêtes</font></b>
...
<?php }} ?>
                    ...
                    <div class="form-group">
											...
											<div class="controls">
													<input type="text" class="form-control" name="reste_a_solder"  readonly required="required" value="3000 FCFA" onKeyPress="return dette(event)" >
												</div>
											</div>
											<div class="form-group">
