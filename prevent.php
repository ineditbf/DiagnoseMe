...
<center>
    ...
    <a href="index.php"> <input type="button" style="color:white;  cursor:pointer;font-size:14px;"  class="btn btn-success" value="Go to Home" /></a> 
	<a href="#vue"> <input type="button" style="color:white;  cursor:pointer;font-size:14px;"  class="btn btn-danger" value="View Suspected case" onclick="insalubrite();corruption();vandalisme();deterioration()"/></a>
	<a href="test.php"> <input type="button" style="color:white;  cursor:pointer;font-size:14px;background:red;border:solid;border-color:red"  class="btn btn-primary " value="DiagnoseMe" /></a>
	   <br>  <br>
